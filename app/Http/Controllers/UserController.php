...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin-user')->with('pesan', 'User  berhasil ditambahkan');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('admin-user')->with('pesan', 'User  berhasil diubah');
    }
    ...
    {
        User::destroy($id);
        return redirect('admin-user')->with('pesan', 'User  berhasil dihapus');
    }
}
