              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    ...
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Single Product V2 </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                    ...
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Blog Grid with Sidebar </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Blog Grid Four Column </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Blog No Sidebar </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Blog Right Sidebar </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Single Post </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Single Post No Sidebar </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
