                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @if($user->role === 'pelanggan')<!-- Only show users with role 'pelanggan' -->
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    ...
                                                    <a href="{{ route('admin-user.edit', $user->id) }}" title="Edit Data" class="btn btn-warning btn-sm"><i class="mdi mdi-grease-pencil"></i></a>
                                                    <form action="{{ route('admin-user.destroy', $user->id) }}" title="Hapus Data" method="post" class="d-inline">
                                                        @method('DELETE')
                                                        @csrf
